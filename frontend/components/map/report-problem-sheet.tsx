...
const URGENCY_OPTIONS: {
  ...
  },
  {
    ...
    desc: 'Tráfego prejudicado',
  },
  {
    id: 'critical',
    label: 'Crítica',
    color: 'border-red-500/50 text-red-600 dark:text-red-400 bg-red-500/10',
    desc: 'Risco iminente',
  },
];
...
export function ReportProblemSheet({
  ...
  React.useEffect(() => {
    if (coordinates) {
      ...
      setAddress(
        (prev) => prev || `Coordenadas: ${lat.toFixed(5)}, ${lng.toFixed(5)}`,
      );
    }
  }, [coordinates]);
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent
        ...
        className='!w-[min(46rem,calc(100vw-1rem))] !max-w-[46rem] overflow-y-auto rounded-l-2xl border-l border-border bg-background p-0 text-foreground shadow-2xl max-sm:bottom-0 max-sm:left-0 max-sm:right-0 max-sm:top-0 max-sm:h-[100dvh] max-sm:!w-full max-sm:!max-w-none max-sm:translate-x-0 max-sm:rounded-none max-sm:border-0'
      >
        <form onSubmit={handleSubmit} className='flex flex-col min-h-full'>
          {/* Sticky Header */}
          <div className='sticky top-0 z-20 flex items-center justify-between gap-3 border-b border-border bg-background/95 px-5 py-5 shadow-xs backdrop-blur-md sm:px-6 sm:py-4 lg:px-8'>
            <div className='flex min-w-0 items-center gap-3'>
              ...
              <div className='min-w-0'>
                ...
                <SheetDescription className='mt-0.5 line-clamp-2 text-xs text-muted-foreground'>
                  Preencha as informações para registrar a ocorrência no mapa
                  urbano.
                </SheetDescription>
              </div>
            </div>
          ...
          <div className='mx-auto flex w-full max-w-2xl flex-1 flex-col gap-5 px-5 py-6 pb-32 sm:gap-6 sm:px-6 sm:py-5 lg:px-8'>
            {errorMessage && (
              <div className='flex items-center gap-2.5 rounded-xl border border-destructive/25 bg-destructive/10 p-3.5 text-xs text-destructive animate-in fade-in'>
            ...
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-3 rounded-2xl border border-border bg-card p-4 shadow-xs sm:p-5'>
                <div className='flex items-center justify-between flex-wrap gap-2'>
                  ...
                  {coordinates ? (
                    <Badge
                      variant='outline'
                      className='font-mono text-xs bg-muted text-foreground border-border'
                    >
              ...
              <div className='flex flex-col gap-2.5 rounded-2xl border border-border/70 bg-muted/10 p-4 sm:p-5'>
                <div className='flex items-center justify-between'>
                  <Label className='text-xs font-semibold text-foreground'>
            ...
            <div className='flex flex-col gap-4 rounded-2xl border border-border bg-card p-4 shadow-xs sm:p-5'>
              <div>
                <Label className='text-xs font-semibold text-foreground'>
                  ...
                  {URGENCY_OPTIONS.map((item) => (
                    <button
                      ...
                      className={cn(
                        ...
                        urgency === item.id
                          ? item.color +
                              ' font-bold ring-1.5 ring-current shadow-xs'
            ...
            <div className='flex flex-col gap-3.5 rounded-2xl border border-border bg-muted/20 p-4 sm:p-5'>
          ...
          <div className='sticky bottom-0 z-30 flex flex-col-reverse gap-2 border-t border-border bg-background/95 px-5 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-3 shadow-lg backdrop-blur-md sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-6 sm:py-4 lg:px-8'>
            <Button
              type='button'
              variant='outline'
              size='default'
            ...
            <Button
              ...
              className='w-full cursor-pointer gap-2 px-5 text-xs font-semibold shadow-sm sm:w-auto'
            >
              {isSubmitting ? (
                <>
